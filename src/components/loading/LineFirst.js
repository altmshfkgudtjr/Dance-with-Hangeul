...
const LineFirst = ({ time, color }) => {
	return (
		<Svg 
			...
			color={color}
		>
			<path id="svg_circle_1" data-name="svg_circle_1" d="M1021.781,526.761a23.963,23.963,0,0,1,20.007,0" transform="translate(-1019.792 -523.073)" strokeLinecap="round" strokeLinejoin="round" />
		</Svg>
	);
}
