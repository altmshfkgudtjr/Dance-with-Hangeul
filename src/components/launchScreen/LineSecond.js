...
const LineFirst = ({ time, color }) => {
	return (
		<Svg 
			...
			color={color}
		>
			<path id="svg_circle_2" data-name="svg_circle_2" d="M1024.781,518.761a25.508,25.508,0,0,1,11.432,0" transform="translate(-1022.983 -516.612)" strokeLinecap="round" strokeLinejoin="round" />
		</Svg>
	);
}
